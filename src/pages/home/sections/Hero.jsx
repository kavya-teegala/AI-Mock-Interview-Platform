  ...
  return (
    <section className="relative pt-44 pb-24 px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          PrepPilot runs realistic mock interviews, scores every answer,
          and tells your resume exactly what's missing — before a recruiter
          ever sees it.
        </motion.p>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-mono text-[var(--color-pulse)]">
              ● live
            </span>
          </div>

          <p className="text-sm text-[var(--color-bone)]">
            "Tell me how you'd design a URL shortener that handles
            50M requests a day."
          </p>
          ...
          <div className="mt-4 flex items-center justify-between">
            <AILoader
              size="sm"
              label="AI is listening to your answer"
            />

            <span className="text-xs font-mono text-[var(--color-fog)]">
              00:42
            </span>
          </div>
        </motion.div>
